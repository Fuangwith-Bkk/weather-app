...
CICD_PROJECT=demo-weather-ci-cd
DEV_PROJECT=demo-weather-dev
PROD_PROJECT=demo-weather-prod
...
PROJECTS=($CICD_PROJECT $DEV_PROJECT  $PROD_PROJECT)
...
echo "set maven-release policy to 'Allow Redeploy' "
